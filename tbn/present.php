...
<html lang="utf-8">
	<head>
        <script async defer src="https://buttons.github.io/buttons.js"></script><!--github按鈕-->
	...
	<body >
		...
		<div id="footer" style="border:1px solid black;">
		    <h2>源起</h2>
                <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;藉由TBN舉辦的黑客松，我們希望能夠讓更多的民眾知道這項計劃，並提升民眾對政府的認同感</p>
                <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;同時也希望透過這個專案，讓更多人參與TBN的生物調查，豐富TBN生物資料</p>
                <a id="linkcolor" target="_blank" href="http://www.tbn.org.tw/Main/Index"><img style='margin-right:10px;' src='img/bull.png'>TBN首頁</a>
            <br/>
            <h2>專案說明</h2>
		...
		<link rel="stylesheet" style ="color:red;" href="stylesheets/page/present.css">		<!--  css -->
